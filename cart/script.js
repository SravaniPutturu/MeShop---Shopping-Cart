...
// var itemType = ['Bag','Tea Shirt','Shirt','Tea Shirt','Bracelet','Ring','Ring','Combo Rings','WD','Drive','WD','TV','WD','TV','Tea Shirt','Tea Shirt','Tea Shirt','Tea Shirt','Tea Shirt','Tea Shirt']
// console.log(itemType.length)
